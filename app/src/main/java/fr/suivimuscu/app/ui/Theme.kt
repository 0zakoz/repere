...
internal fun themeDefinition(theme: AppThemeId, dark: Boolean): AppThemeDefinition = when (theme to dark) {
    ...
    AppThemeId.KAWAII to false -> definition(
        ...
        visuals(Color(0xFFA83B78), Color(0xFF955C00), Color(0xFF6650A4),
    ...
    AppThemeId.KAWAII to true -> definition(
        ...
        visuals(Color(0xFFFF9BCD), Color(0xFFFFD18A), Color(0xFFCDBDFF),
    ...
    AppThemeId.PASTEL to false -> definition(
        ...
        visuals(Color(0xFFA53D68), Color(0xFF756000), Color(0xFF32678F),
    ...
    AppThemeId.PASTEL to true -> definition(
        ...
        visuals(Color(0xFFFFB0CE), Color(0xFFFFE083), Color(0xFFA9D6F5),
    ...
    AppThemeId.OLED to false -> definition(
        ...
        visuals(Color(0xFF3047B8), Color(0xFF8B5800), Color(0xFF007683),
    ...
    AppThemeId.OLED to true -> definition(
        ...
        visuals(Color(0xFF4DE7FF), Color(0xFFFFC857), Color(0xFF9E8CFF),
    ...
    AppThemeId.PURE to false -> definition(
        ...
        visuals(Color(0xFF4E6175), Color(0xFF756B36), Color(0xFF426B78),
    ...
    AppThemeId.PURE to true -> definition(
        ...
        visuals(Color(0xFFAED7F4), Color(0xFFF1E28D), Color(0xFFAED7F4),
