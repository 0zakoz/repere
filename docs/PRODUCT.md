...
- **Muscles** : séries pondérées par semaine et sur la période, répétitions et RIR moyens,
  ...
  RIR moyens. L’intensité suit la part du volume maximal : les muscles non sollicités restent
  neutres. Les poids sont principal ×1, secondaire ×0,5 et tertiaire ×0,25.
