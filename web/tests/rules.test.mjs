...
import { MUSCLE_REGIONS, heatFill, heatFraction, renderMuscleFigure } from "../js/muscleFigure.js";
...
test("la fraction heatmap suit la parité Android", () => {
  ...
  assert.ok(heatFill(0).includes("0%"));
  assert.ok(heatFill(1).includes("100%"));
});
